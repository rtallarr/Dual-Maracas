...
export class BlockListComponent {
  ...
  DuradelTasks: TaskData[] = [
    {id: '1', name: 'Aberrant spectres', status: 'Active', weight: 7, slayer: 60},
    {id: '2', name: 'Abyssal Demon', status: 'Active', weight: 12, slayer: 85},
    ...
    {id: '6', name: 'Basilisks', status: 'Locked', weight: 7, slayer: 40},
    {id: '7', name: 'Black demons', status: 'Active', weight: 8},
    {id: '8', name: 'Black dragons', status: 'Active', weight: 9},
    {id: '9', name: 'Bloodvelds', status: 'Active', weight: 8, slayer: 50},
    {id: '10', name: 'Blue dragons', status: 'Active', weight: 4},
    {id: '11', name: 'Boss', status: 'Locked', weight: 12},
    {id: '13', name: 'Cave horros', status: 'Active', weight: 4, slayer: 58},
    {id: '14', name: 'Cave kraken', status: 'Active', weight: 9, slayer: 87},
    {id: '15', name: 'Dagannoth', status: 'Active', weight: 9},
    {id: '16', name: 'Dark beasts', status: 'Active', weight: 11, slayer: 90},
    {id: '17', name: 'Drakes', status: 'Active', weight: 8, slayer: 84},
    {id: '18', name: 'Dust devils', status: 'Active', weight: 5, slayer: 65},
    {id: '19', name: 'Elves', status: 'Active', weight: 4},
    {id: '20', name: 'Fire giants', status: 'Active', weight: 7},
    {id: '21', name: 'Fossil Island Wyverns', status: 'Active', weight: 7, slayer: 66},
    {id: '22', name: 'Gargoyles', status: 'Active', weight: 8, slayer: 75},
    ...
    {id: '27', name: 'Kurasks', status: 'Active', weight: 4, slayer: 70},
    {id: '28', name: 'Lizardmen', status: 'Locked', weight: 10},
    {id: '29', name: 'Mithril dragons', status: 'Locked', weight: 9},
    {id: '30', name: 'Mutated Zygomites', status: 'Active', weight: 2, slayer: 57},
    {id: '31', name: 'Nechryael', status: 'Active', weight: 9, slayer: 80},
    {id: '32', name: 'Red dragons', status: 'Locked', weight: 8},
    {id: '33', name: 'Rune dragons', status: 'Active', weight: 2},
    {id: '34', name: 'Skeletal wyverns', status: 'Active', weight: 7, slayer: 72},
    {id: '35', name: 'Smoke devils', status: 'Active', weight: 9, slayer: 93},
    {id: '36', name: 'Spiritual creatures', status: 'Active', weight: 7, slayer: 63},
    ...
    {id: '44', name: 'Wyrms', status: 'Active', weight: 8, slayer: 62},
  ];
