...
*/
  ...
  NieveTasks: TaskData[] = [
    ...
    {id: '20', name: 'Fire giants', status: 'Active', weight: 9, slayer: 1, combat: 65},
    {id: '21', name: 'Fossil Island Wyverns', status: 'Active', weight: 5, slayer: 66, combat: 60},
    {id: '22', name: 'Gargoyles', status: 'Active', weight: 6, slayer: 75, combat: 80},
    {id: '23', name: 'Greater demons', status: 'Active', weight: 7, slayer: 1, combat: 75},
    {id: '24', name: 'Hellhounds', status: 'Active', weight: 8, slayer: 1, combat: 75},
    {id: '25', name: 'Iron dragons', status: 'Active', weight: 5, slayer: 1, combat: 80},
    {id: '26', name: 'Kalphites', status: 'Active', weight: 9, slayer: 1, combat: 1},
    {id: '27', name: 'Kurasks', status: 'Active', weight: 3, slayer: 70, combat: 65},
    {id: '28', name: 'Lizardmen', status: 'Active', weight: 8, slayer: 1, combat: 1},
    {id: '29', name: 'Minions of Scabaras', status: 'Active', weight: 4, slayer: 1, combat: 85},
    {id: '30', name: 'Mithril dragons', status: 'Locked', weight: 5, slayer: 1, combat: 1},
    {id: '31', name: 'Mutated Zygomites', status: 'Active', weight: 2, slayer: 57, combat: 60},
    {id: '32', name: 'Nechryael', status: 'Active', weight: 7, slayer: 80, combat: 85},
    {id: '33', name: 'Red dragons', status: 'Locked', weight: 5, slayer: 1, combat: 68},
    {id: '34', name: 'Rune dragons', status: 'Active', weight: 2, slayer: 1, combat: 1},
    {id: '35', name: 'Skeletal wyverns', status: 'Active', weight: 7, slayer: 72, combat: 70},
    {id: '36', name: 'Smoke devils', status: 'Active', weight: 7, slayer: 93, combat: 85},
    {id: '37', name: 'Spiritual creatures', status: 'Active', weight: 6, slayer: 63, combat: 60},
    {id: '38', name: 'Steel dragons', status: 'Active', weight: 7, slayer: 1, combat: 85},
    {id: '39', name: 'Suqahs', status: 'Active', weight: 8, slayer: 1, combat: 85},
    {id: '40', name: 'Trolls', status: 'Active', weight: 6, slayer: 1, combat: 60},
    {id: '41', name: 'Turoth', status: 'Active', weight: 3, slayer: 55, combat: 60},
    {id: '42', name: 'TzHaar', status: 'Locked', weight: 10, slayer: 1, combat: 1},
    {id: '43', name: 'Vampyres', status: 'Locked', weight: 6, slayer: 1, combat: 1},
    {id: '44', name: 'Warped creatures', status: 'Locked', weight: 6, slayer: 1, combat: 1},
    {id: '45', name: 'Wyrms', status: 'Active', weight: 7, slayer: 62, combat: 75}
  ];
  ...
  ChaeldarTasks: TaskData[] = [
    ...
    {id: '29', name: 'Mithril dragons', status: 'Locked', weight: 5, slayer: 1, combat: 1},
    {id: '30', name: 'Mutated Zygomites', status: 'Active', weight: 2, slayer: 57, combat: 60},
    {id: '31', name: 'Nechryael', status: 'Active', weight: 7, slayer: 80, combat: 85},
    {id: '32', name: 'Red dragons', status: 'Locked', weight: 5, slayer: 1, combat: 68},
    {id: '33', name: 'Rune dragons', status: 'Active', weight: 5, slayer: 1, combat: 1},
    {id: '34', name: 'Skeletal wyverns', status: 'Active', weight: 7, slayer: 72, combat: 70},
    {id: '35', name: 'Smoke devils', status: 'Active', weight: 7, slayer: 93, combat: 85},
    {id: '36', name: 'Spiritual creatures', status: 'Active', weight: 6, slayer: 63, combat: 60},
    {id: '37', name: 'Steel dragons', status: 'Active', weight: 7, slayer: 1, combat: 85},
    {id: '38', name: 'Suqahs', status: 'Active', weight: 8, slayer: 1, combat: 85},
    {id: '39', name: 'Trolls', status: 'Active', weight: 6, slayer: 1, combat: 60},
    {id: '40', name: 'Turoth', status: 'Active', weight: 3, slayer: 55, combat: 60},
    {id: '41', name: 'Vampyres', status: 'Locked', weight: 6, slayer: 1, combat: 1},
    {id: '42', name: 'Warped creatures', status: 'Locked', weight: 6, slayer: 1, combat: 1},
    {id: '43', name: 'Waterfiends', status: 'Active', weight: 2, slayer: 1, combat: 1},
    {id: '44', name: 'Wyrms', status: 'Active', weight: 7, slayer: 62, combat: 75}
  ];
